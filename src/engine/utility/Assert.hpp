#ifndef PEN_SRC_ENGINE_CORE_UTILITY_HPP
#define PEN_SRC_ENGINE_CORE_UTILITY_HPP

#include <cstdio>
#include <cstdlib>
#include <source_location>

namespace pen::assertion
{
...
// NOTE: Ensure PEN_ENABLE_ASSERTIONS is defined
#if !defined(PEN_ENABLE_ASSERTIONS)
#    define PEN_ENABLE_ASSERTIONS 0
#endif

#if PEN_ENABLE_ASSERTIONS
...
#    define PEN_ASSERT(cond, ...)                                                                  \
        do                                                                                         \
        {                                                                                          \
            if(!(cond))                                                                            \
            {                                                                                      \
                ::pen::assertion::assertion_fail(#cond, ::pen::assertion::msgOrNull(__VA_ARGS__)); \
            }                                                                                      \
        }                                                                                          \
        while(0)
#else
#    define PEN_ASSERT(cond, ...) ((void)0)
#endif
// NOLINTEND(cppcoreguidelines-macro-usage, cppcoreguidelines-avoid-do-while)

#endif // !PEN_SRC_ENGINE_CORE_UTILITY_HPP
